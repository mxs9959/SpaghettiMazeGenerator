...
from load import export_maze_to_csv
...
class MazeGeneratorUI:
    ...
    def _create_config_frame(self):
        ...
        self.export_status_banner = tk.Label(
            self.config_frame,
            text="",
            bg="green",
            fg="white",
    ...
    def generate_maze(self):
        # Remove status banners if present
        try:
            self.status_banner.pack_forget()
            self.export_status_banner.pack_forget()
        except:
            pass
    ...
    def export_maze(self):
        ...
        try:
            ...
            self.export_status_banner.config(text=f"Exported maze to {filepath}")
            self.export_status_banner.pack(side=tk.LEFT, padx=(10, 0))
