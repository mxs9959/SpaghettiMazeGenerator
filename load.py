#This file was originally generated by Claude, but Max and Owen needed to make a few edits to each of the methods.
#Additional notes, if necessary, are next to the method headers.
#Most of the code in this file doesn't have much to do with the actual generation or solving, just storage and PNG exports.
...
def export_maze_to_png(canvas_widget, image):
    ...
    #ChatGPT generated this segment for the alert box:
